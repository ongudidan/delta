...
/**
 * This is the model class for table "bulk_sale".
 *
 * @property int $id
 ...
 */
class BulkSale extends \yii\db\ActiveRecord
{
    public $date;
    ...
    {
        return [
            [[ 'created_at', 'sale_date', 'updated_at'], 'integer'],
    ...
    {
        return $this->hasMany(Sales::class, ['bulk_sale_id' => 'id']);
    }
