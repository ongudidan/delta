...
class ExpensesSearch extends Expenses
{
    ...
    {
        return [
            [['expense_id', 'expense_category_id', 'created_at', 'updated_at'], 'integer'],
            [['amount'], 'number'],
            [['globalSearch'], 'safe'],
    ...
    {
        $query = Expenses::find()->orderBy(['updated_at'=> SORT_DESC]);
        ...
        $query->orFilterWhere(['like', 'expense_categories.category_name', $this->globalSearch]);
