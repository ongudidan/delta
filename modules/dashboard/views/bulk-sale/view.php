        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mb-3">
                    <a href="<?= Url::to(['/dashboard/bulk-sale/update', 'id' => $model->id]) ?>" class="btn btn-sm btn-outline-primary me-2">
                        <i class="feather-edit"></i> Edit
                    </a>
                    <a href="#" class="btn btn-sm btn-outline-danger delete-btn" data-url="<?= Url::to(['/dashboard/bulk-sale/delete', 'id' => $model->id]) ?>">
