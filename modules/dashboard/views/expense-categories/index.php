...
<div class="expense-categories-index">
    ...
    <div class="category-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/dashboard/expense-categories/index']) ?>">
                <div class="row">

                    <div class="col-lg-10 col-md-6">
                        <div class="form-group">
                            <input type="text" name="ExpenseCategoriesSearch[category_name]" class="form-control" placeholder="Category Name ..." value="<?= Html::encode($searchModel->category_name) ?>">
                        </div>
                    </div>
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/dashboard/expense-categories/create') ?>" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/dashboard/expense-categories/view', 'expense_category_id' => $category->expense_category_id]) ?>">
                                                            <i class="feather-eye"></i> View
                                                        </a>
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/dashboard/expense-categories/update', 'expense_category_id' => $category->expense_category_id]) ?>">
                                                            <i class="feather-edit"></i> Update
                                                        </a>
                                                        <a class="dropdown-item has-icon delete-btn" href="#" data-url="<?= Url::to(['/dashboard/expense-categories/delete', 'expense_category_id' => $category->expense_category_id]) ?>">
