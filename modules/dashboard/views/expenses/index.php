...
/** @var app\modules\dashboard\models\ExpensesSearch $searchModel */
...
<div class="expenses-index">
    ...
    <div class="expense-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/dashboard/expenses/index']) ?>">
                <div class="row">

                    <div class="col-lg-10 col-md-6">
                        <div class="form-group">
                            <input type="text" name="ExpensesSearch[expense_category_id]" class="form-control" placeholder="Search by expense_category_id ..." value="<?= Html::encode($searchModel->expense_category_id) ?>">
                        </div>
                    </div>
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/dashboard/expenses/create') ?>" class="btn btn-primary"><i
                                ...
                                ?>
                                    <?php foreach ($dataProvider->getModels() as $index => $expense): ?>
                                        <tr>
                                            ...
                                            <td><?= User::findOne($expense->created_by)->username ?? '{not set}' ?></td>
                                            <td><?= Yii::$app->formatter->asDatetime($expense->created_at) ?></td>
                                            <td>
