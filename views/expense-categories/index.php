                        ...
                        <div class="tab-content no-padding" id="myTab2Content">
                            <div class="tab-pane fade active show" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                ...
                                <div class="card-header">
                                    <h4>
                                        <p>
                                            <?= Html::a('Create New Expense Category', ['create'], ['class' => 'btn btn-success']) ?>
                                        </p>
                                    </h4>
                                    <div class="card-header-action">
                                        <form method="get" action="<?= Url::to(['index']) ?>">
                                            <div class="input-group">
                                                <input type="text" name="ExpensesCategoriesSearch[globalSearch]" class="form-control" placeholder="Search by category name" value="<?= Html::encode($searchModel->globalSearch) ?>">
                                            ...
                                            <tbody class="ui-sortable">
                                                <?php foreach ($dataProvider->getModels() as $index => $category) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= Html::encode(Yii::$app->formatter->asDatetime($category->updated_at)) ?></td>
                                                        <td>
                                                            <div class="dropdown d-inline">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -133px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a class="dropdown-item has-icon" href="<?= Url::to(['expense-categories/view', 'expense_category_id' => $category->expense_category_id]) ?>"><i class="far fa-heart"></i> View</a>
                                                                    <a class="dropdown-item has-icon" href="<?= Url::to(['expense-categories/update', 'expense_category_id' => $category->expense_category_id]) ?>"><i class="far fa-file"></i> Update</a>
                                                                    <a class="dropdown-item has-icon delete-btn" href="<?= Url::to(['expense-categories/delete', 'expense_category_id' => $category->expense_category_id]) ?>" data-url="<?= Url::to(['expense-categories/delete', 'expense_category_id' => $category->expense_category_id]) ?>">
