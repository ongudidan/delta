                                        ...
                                        <div class="card l-bg-green">
                                            <div class="card-statistic-3">
                                                ...
                                                <div class="card-content">
                                                    <h4 class="card-title">Today expenses</h4>
                                                    <span>524</span>
                                    ...
                                    <div class="col-xl-3 col-lg-6">
                                        <div class="card l-bg-cyan">
                                            <div class="card-statistic-3">
                                                ...
                                                <div class="card-content">
                                                    <h4 class="card-title">This week expenses</h4>
                                                    <span>1,258</span>
                                                    <div class="progress mt-1 mb-1" data-height="8" style="height: 8px;">
                                    ...
                                    <div class="col-xl-3 col-lg-6">
                                        <div class="card l-bg-purple">
                                            <div class="card-statistic-3">
                                                ...
                                                <div class="card-content">
                                                    <h4 class="card-title">This month expenses</h4>
                                                    <span>10,225</span>
                                                    <div class="progress mt-1 mb-1" data-height="8" style="height: 8px;">
                                    ...
                                    <div class="col-xl-3 col-lg-6">
                                        <div class="card l-bg-orange">
                                            <div class="card-statistic-3">
                                                ...
                                                <div class="card-content">
                                                    <h4 class="card-title">This year expenses</h4>
                                                    <span>$2,658</span>
                                                    <div class="progress mt-1 mb-1" data-height="8" style="height: 8px;">
