        ...
        <div class="card-body">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <?= $form->field($model, 'quantity')->textInput(['maxlength' => true, 'placeholder' => 'Enter quantity',]) ?>
                </div>
                <div class="form-group col-md-6">
                    <?= $form->field($model, 'buying_price')->textInput(['maxlength' => true, 'placeholder' => 'Enter buying price',]) ?>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
